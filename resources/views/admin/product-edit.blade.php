        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="pages/ui-features/buttons.html">Manufacturer List</a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Add New</a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Edit/Delete</a></li>
                </ul>
              </div>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                 ...
                 <button><li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Add New</a></li></button> 
            ...
            <div class="card">
              <div class="card-body">
                <h3 class="card-title">Product edit</h3>
                  ...
                  @endif
                    <form class="forms-sample" method="POST" action="{{ url('product-update', $data->productID) }}" enctype="multipart/form-data">
                     @csrf
                      ...
                      <div class="form-group">
                        ...
                        value="{{$data->productDate}}" name="date">
                    </div>
                          ...
                          <div class="form-group">
                            ...
                            <select type="number" name="manufacturer" id="manufacturer" class="form-control">
                              @foreach ($manu as $manus)
                                <option value="{{$manus->manufacturerID}}">{{$manus->manufacturerName}}</option>
                              @endforeach
                            </select>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <input type="file" name="productImage1" id="productImage1" class="form-control-file" accept="image/*" required>
                      </div>
